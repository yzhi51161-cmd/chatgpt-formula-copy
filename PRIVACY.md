...
- 油猴版最多每 3 天向 GitHub 的公开脚本地址请求一次版本号，用于提示可用更新；请求不包含聊天内容、公式、选区或任何用户标识。
...
- At most once every 3 days, the Userscript requests its public GitHub source to read the published version and surface an available update. The request contains no chat content, formulas, selections, or user identifiers.
