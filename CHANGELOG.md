...
- Refined the page-panel logo into a focused 256px crop for clearer face and formula details, moved the project Star link into the header, and exposed the `EN` / `中` language switch there as well.
